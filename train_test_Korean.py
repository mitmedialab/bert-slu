...
#importing files
from prepare_symptom_dataset_Spanish import train_dataset, val_dataset, tokenizer, test_dataset, intent_dim
...
model = BertForSequenceClassification.from_pretrained(
    "mrm8488/bert-spanish-cased-finetuned-ner", # Use the 12-layer BERT model, with an uncased vocab.
...
#
#
# model = AutoModelWithLMHead.from_pretrained("asafaya/bert-base-arabic")
