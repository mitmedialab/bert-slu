...
csv_file = './data/symptom_dataset_short_korean.csv'
...
df_classes.to_csv('./data/Korean_intent_id_to_label.csv', sep='\t', encoding='utf-8', index=True)
...
# print('Loading BERT tokenizer...') FOR Korean
