...
import numpy as np
from data import train_dataset, val_dataset, tokenizer, test_dataset, intent_dim, slots_dim
...
for epoch_i in range(0, epochs):
    ...
    if (epoch_i + 1) % 5 == 0 or epoch_i == 0:
        ...
        for batch in validation_dataloader:
            ...
            total_eval_accuracy += intent_accuracy(logits, label_ids)
...
import json
with open(params.data_path+"results.json", 'w') as f:
